        ...
        try:
            ...
            **[작성 원칙 - 텍스트 양식 엄수]**
            ...
            2. **구조 (형님 명령 절대 준수)**:
               ...
               - **# Method 2: 빠른 풀이**
               - **# Method 3: 직관 풀이**
            3. **수식**: LaTeX($...$) 사용. **분수는 무조건 `\\dfrac` 사용.**
            4. **[핵심] 문장 줄바꿈 및 위계질서**:
               - **글머리 기호(○)**를 사용하여 풀이의 깊이(위계)를 명확히 보여줘. 
               - **가장 중요:** **모든 문장은 마침표(.)가 찍히면 무조건 줄바꿈(Enter)을 해.** 절대 문장을 옆으로 길게 이어 쓰지 마.
               - 예시:
                 ○ 기울기가 -1이므로, x=k, l 입니다.
                   (줄바꿈)
                  ○ 만약 x=k라면 y=2가 됩니다.
            ...
            **[Python 코드 작성 시 절대 주의사항]**
            ...
            4. **[표시 요소 제한 - 형님 지시사항]**:
               ...
               - 오직 **수식($y=...$), 점의 좌표((x,y)), 선분의 길이**만 표시해.
            ...
            10. 그 외 불필요한 요소(복잡한 격자, 너무 많은 눈금 등)는 제거해서 깔끔하게 해.
